...
import ModalElimnarTarea from "../components/ModalElimiar"
            ...
            {admin && (
                <>
                    <div className="flex items-center justify-between">
                        ...
                        <Link to={`/proyectos/nuevo-colaborador/${proyecto._id}`} className="text-gray-400 font-bold uppercase hover:text-black">
                            Añadir
                        </Link>
                    </div>
                    <div className="bg-white shadow mt-10 rounded-lg">
