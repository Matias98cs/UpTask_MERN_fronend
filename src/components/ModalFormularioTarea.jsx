...
const ModalFormularioTarea = () => {
    ...
    const { modalFormularioTarea, handleModalTarea, mostrarAlerta, alerta, submitTarea, tarea, handleModalEditarTarea } = useProyectos()
    const { id } = useParams()
    ...
    const handleSubmit = async (e) => {
        ...
        await submitTarea({ nombre, descripcion, prioridad, fechaEntrega, proyecto: id, id: getId })
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                        {getId ? 'Actualizar Tarea' : ' Crear Tarea'}
                                    </Dialog.Title>
                                    ...
                                    <form
                                        ...
                                        <div className='mb-5'>
                                            <label htmlFor="fecha-entrega" className='text-gray-700 uppercase font-bold text-sm'>Fecha de Entrega de Tarea</label>
                                            <input
                                                type="date"
                                                id='fecha-entrega'
                                                value={fechaEntrega}
                                        ...
                                        <input
                                            ...
                                            value={getId ? 'Guardar Cambios' : "Crear Tarea"}
                                        />
                                    </form>
                                </div>
                            </div>
